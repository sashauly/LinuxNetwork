...
- */8*, 
  ...
  ![part1](./images/1.3.1.png)
- *11111111.11111111.00000000.00000000*,
  - 12.167.0.1 - min
  - 12.167.255.254 - max

  ![part1](./images/1.3.2.png)
- *255.255.254.0*
  - 12.167.38.1 - min
  - 12.167.38.254 - max

  ![part1](./images/1.3.3.png)
- */4*
  - 0.0.0.1 - min
  - 15.255.255.254 - max

  ![part1](./images/1.3.4.png)

#### 1.2. localhost
##### Определить и записать в отчёт, можно ли обратиться к приложению, работающему на localhost, со следующими IP:
> Адреса на localhost должны находиться в диапазоне 127.0.0.1 - 127.255.255.254
> ![part1](./images/localhost.png)
...
- ws1
  > ![part1](./images/2_ip_a.png)
- ws2
  >![part1](./images/2_ip_a_2.png)
...
- ws1
  > ![part1](./images/yaml_ws1.png)
- ws2
  > ![part1](./images/yaml_ws2.png)
...
- ws1
  ...
  > `ping 172.24.116.8`
  >
  > ![part1](./images/2.1_ws1.png)
- ws2
  > `sudo ip r add 192.168.100.10 dev enp0s3`
  > 
  > `ping 192.168.100.10`
  >
  > ![part1](./images/2.1_ws2.png)
...
- ws1
  > ![part1](./images/2.2_ws1.png)
- ws2
  > ![part1](./images/2.2_ws2.png)
##### Пропинговать соединение между машинами
- В отчёт поместить скрин с вызовом и выводом использованной команды.
- ws1
  > `ping -c 4 172.24.116.8`
  > ![part1](./images/2.2ping1.png)
- ws2
  > `ping -c 4 192.168.100.10`
  > ![part1](./images/2.2ping2.png)
...
> ![part1](./images/3.2ad1.png)
> ![part1](./images/3.2ad2.png)
>
> Далее необходимо скорректировать yaml файлы на обеих машинах для настройки нужного порта enp0s8.
> - ws1
> ![part1](./images/3.2yaml1.png)
> - ws2
> ![part1](./images/3.2yaml2.png)
>
...
> 
>   `iperf -s`
> ![part1](./images/3.2i1.png)
> - ws2
> 
>   `iperf -c 192.168.100.10`
> ![part1](./images/3.2i2.png)
...
> - ws1 
  ![part1](./images/4.11.png)
> - ws2
  ![part1](./images/4.12.png)
##### Запустить файлы на обеих машинах командами `chmod +x /etc/firewall.sh` и `/etc/firewall.sh`
- В отчёт поместить скрины с запуском обоих файлов.
> - ws1 
  ![part1](./images/411.png)
> - ws2
  ![part1](./images/412.png)
...
>   ![part1](./images/4.21.png)
>   - `sudo nmap 172.24.116.8`
>   ![part1](./images/4.22.png)

> - ws2
>   - `ping -c 5 192.168.100.10`
>   ![part1](./images/421.png)
>   - `sudo nmap 192.168.100.10`
>   ![part1](./images/422.png)
...
> - r1
>   - ![part1](./images/r11.png)
> - r2
>   - ![part1](./images/r21.png)
> - ws11
>   - ![part1](./images/ws111.png)
> - ws22
>   - ![part1](./images/ws221.png)
> - ws21
>   - ![part1](./images/ws211.png)
##### Перезапустить сервис сети. Если ошибок нет, то командой `ip -4 a` проверить, что адрес машины задан верно. Также пропинговать ws22 с ws21. Аналогично пропинговать r1 с ws11.
- В отчёт поместить скрины с вызовом и выводом использованных команд.
> - r1
>   - ![part1](./images/r12.png)
> - r2
>   - ![part1](./images/r22.png)
> - ws11
>   - ![part1](./images/ws112.png)
> - ws22
>   - ![part1](./images/ws222.png)
> - ws21
>   - ![part1](./images/ws212.png)
>
> - Пинг ws22 с ws21 `ping -c 5 10.20.0.20`
>   - ![part1](./images/ws22ws21.png)
> - Пинг r1 с ws11 `ping -c 5 10.10.0.1`
>   - ![part1](./images/r1ws11.png)
